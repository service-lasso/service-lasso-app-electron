...
Template repo for an Electron-hosted Service Lasso desktop app.

Package identity:
- `@service-lasso/service-lasso-app-electron`

Purpose:
- show how to host Service Lasso behind an Electron desktop shell
...
- desktop host entrypoint under `src/index.js`
...
- explicit `src-electron/` next-step config for a future native wrapper

Current local start command:
- `npm start`

Current local URLs:
- desktop shell: `http://127.0.0.1:19160`
- embedded admin UI: `http://127.0.0.1:19160/admin/`
- runtime API: `http://127.0.0.1:18081`

## Current release artifact

This starter repo now has a bounded desktop-host release artifact.
...
- this repo ships a runnable Electron-host starter plus a starter-template source bundle
