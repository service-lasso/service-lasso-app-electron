...
test("desktop starter servicesRoot is prepared from tracked service manifests without a generated wrapper", async () => {
  const root = await mkdtemp(path.join(tmpdir(), "service-lasso-app-electron-services-"));
