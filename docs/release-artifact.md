...
Artifact:
- `service-lasso-app-electron-<version>-bundled.tar.gz`
...
This app-electron starter now uses that tracked inventory directly for bootstrap-download and bundled behavior.
