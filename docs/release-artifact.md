...
Artifact:
- `service-lasso-app-electron-<version>-source.tar.gz`
...
Artifact:
- `service-lasso-app-electron-<version>-runtime.tar.gz`

Purpose:
- provide a ready-to-run Electron-oriented host with the core runtime already installed
...
Artifact:
- `service-lasso-app-electron-<version>-preloaded.tar.gz`
...
- the Electron-oriented host can be packaged repeatably
...
This app-electron starter now uses that tracked inventory directly for bootstrap-download and preloaded behavior.
