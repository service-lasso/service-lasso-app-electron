  ...
  <body>
    <main>
      <section class="panel">
        ...
        <p>
          This bounded host keeps the runtime and admin wiring executable today, while the future native Electron wrapper simply needs to point its window at this local shell.
        </p>
        <div class="card">
